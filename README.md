...
You can use IDs to retrieve a specific module or omit the ID to get the first instance that redux-classic finds.
...
To calculate values from other parts of the modules state instead of using a fancy _selector_ function you can simply use a standard javascript getter.
